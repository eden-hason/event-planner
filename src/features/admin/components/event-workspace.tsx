  ...
  try {
    ...
    return (
      <Band
        ...
        // Bulk sending is gone (ADR 0013): a Schedule sends when its Due Time
        // comes, and the one manual path left is the per-delivery send on the
        // timeline itself, capped at ten guest records.
        action={canPlanCalls ? (
