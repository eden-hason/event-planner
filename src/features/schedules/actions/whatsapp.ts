 ...
 *
 * Kept for the paths that build a message and send it in one breath - the test
 * message an Owner sends themselves. The pipeline does not use it: the
 * Dispatcher renders and the Worker posts, and the two are deliberately not one
 * call.
 */
