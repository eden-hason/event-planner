...
/*
 * ReUI Timeline (https://reui.io/components/timeline), the free radix-nova item.
 *
 * Changed from the registry source so it lays out correctly in RTL: the rail is
 * placed with logical `start` insets rather than `left` plus a `translate-x`,
 * which put the dots on the wrong side of a Hebrew page. The indicator now sits
 * in the item's margin column (`-start-8`, 16px wide, 32px margin) and the
 * separator is centred under it (`-start-[25px]`, 2px wide).
 */
